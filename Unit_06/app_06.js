...
// Task 9
// Создайте функцию t9, которая принимает
// два параметра - имя папки и файла и проверяет
// есть ли данный файл в папке. Функция должна возвращать true или false.

function t9(folder, file) {
     fs.readdir(folder, 'utf-8', (err, data) => {
       return console.log(data.includes(file));
    });
}
console.log(t9('home7', 't3.txt'));


// Task 10
// Создайте функцию t10, которая принимает
// имя файла и которая возвращает false если
// файла нет в текущей папке или его размер равен
// нулю и размер файла если он существует и его размер больше нуля.
